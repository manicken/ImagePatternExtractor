    ...
    {        
        ...
        */
        ...
        private void mPictureBox_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            int x = e.X, y = e.Y;
            if (x > mPictureBox.Width) { x = mPictureBox.Width - 1; Cursor.Position = mPictureBox.PointToScreen(new Point(x, y)); }
            if (y > mPictureBox.Height) { y = mPictureBox.Height - 1; Cursor.Position = mPictureBox.PointToScreen(new Point(x, y)); }
            int dx = x - oldX;
            int dy = y - oldY;
            oldX = x;
            oldY = y;
