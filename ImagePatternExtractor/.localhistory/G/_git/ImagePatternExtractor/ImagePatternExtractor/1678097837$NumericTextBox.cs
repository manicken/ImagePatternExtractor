...
{
    public class NumericTextBox : GenericNumericTextBox<int> { }
    public class NumericDobuleTextBox : GenericNumericTextBox<double> { }
    public class NumericDecimalTextBox : GenericNumericTextBox<decimal> { }
    ...
    public class GenericNumericTextBox<T> : TextBox
    {
        ...
        public T Value
        {
            get
            {
                if (typeof(T) == typeof(int)) return int.TryParse(Text, out var value) ? value : DefaultValue;
            }
