...
namespace WeaveImagePatternExtractor
{
    public class NumericTextBox : TextBox
    {
        ...
        [Browsable(true)]
        public decimal Decimal { get => decimal.TryParse(Text, out var value) ? value : DefaultDoubleValue; set => Text = value.ToString(); }
        public double Double { get => double.TryParse(Text, out var value) ? value : DefaultDecimalValue; set => Text = value.ToString(); }
    [Browsable(true)]
