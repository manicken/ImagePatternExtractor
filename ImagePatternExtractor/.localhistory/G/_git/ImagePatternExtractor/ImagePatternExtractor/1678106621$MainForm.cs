...
namespace WeaveImagePatternExtractor
{
    public partial class MainForm : Form
    {
        ...
        {
            int pixelSize = txtEditorPixelSize.Value;// Int32.Parse(txtEditorPixelSize.Text);
            int pixelSpacing = txtEditorPixelSpacing.Value;// Int32.Parse(txtEditorPixelSpacing.Text);
            int pixelTotalSize = (pixelSize + pixelSpacing);
