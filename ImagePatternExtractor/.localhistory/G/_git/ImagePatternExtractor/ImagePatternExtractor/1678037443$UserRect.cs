        ...
        private void mPictureBox_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            switch (nodeSelected)
            {
                ...
                default:
                    if (mMove)
                    {
                            rect.X = rect.X + x - oldX;
                            rect.Y = rect.Y + y - oldY;
                    }
                    break;
            }
            oldX = x;
            ...
            rect.X -= rect.X - (rect.X / xSnapSize) * xSnapSize;
            rect.Y -= rect.Y - (rect.Y / ySnapSize) * ySnapSize;
            rect.Width -= rect.Width - (rect.Width / xSnapSize) * xSnapSize;
            rect.Height -= rect.Height - (rect.Height / ySnapSize) * ySnapSize;
