namespace WeaveImagePatternExtractor
{
    partial class ExtractForm
    {
        ...
        {
            this.txtXoffset = new IntegerValueTextBox();
            this.txtYparts = new IntegerValueTextBox();
            this.txtXparts = new IntegerValueTextBox();
            this.txtYoffset = new IntegerValueTextBox();
            ...
            this.txtBthreshold = new IntegerValueTextBox();
            this.label6 = new System.Windows.Forms.Label();
            this.txtGthreshold = new IntegerValueTextBox();
            this.label5 = new System.Windows.Forms.Label();
            this.txtRthreshold = new IntegerValueTextBox();
