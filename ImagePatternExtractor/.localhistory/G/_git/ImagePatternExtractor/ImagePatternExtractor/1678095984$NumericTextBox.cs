...
namespace WeaveImagePatternExtractor
{
    public class NumericTextBox : TextBox
    {
        ...
        private double defaultDoubleVal = 0.0f;
        private decimal defaultDecimalVal = Decimal.Zero;
        ...
        public int DefaultIntVal { get; set; } = 0;
        public int DefaultDoubleVal { get; set; } = 0.0f;
        public int DefaultDecimalVal { get; set; } = Decimal.Zero;
