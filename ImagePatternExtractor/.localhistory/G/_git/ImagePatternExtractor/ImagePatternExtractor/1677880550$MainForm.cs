    ...
    public partial class MainForm : Form
    {
        ...
        private void PrintZoomedPatternImage()
        {
            ...
            for (int y = 0; y < imgOut.Height; y++)
            {
                ...
                {
                    graphics.FillRectangle(new SolidBrush(imgOut.GetPixel(x, y)), x * (pixelSize + pixelSpacing), y * (pixelSize + pixelSpacing), pixelSize, pixelSize);
                }
            }
        ...
        private void PrintPreviewPatternImage()
        {
            ...
            int xCopies = picPreview.Width / imgOut.Width;
            int yCopies = picPreview.Height / imgOut.Height;
