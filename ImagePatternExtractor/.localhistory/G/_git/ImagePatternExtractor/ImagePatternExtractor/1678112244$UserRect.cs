...
namespace UserRectDemo
{
    ...
    {        
        ...
        public int SnapSize
        {
            set { xSnapSize = value; ySnapSize = value; }
        }
        ...
        */
        ...
        private Rectangle GetRect(PosSizableRect p)
        {
            switch (p)
            {
                ...
                case PosSizableRect.LeftMiddle:
                    return CreateRectSizableNode(rectDraw.X, rectDraw.Y + rectDraw.Height / 2, sizeNodeRect, rectDraw.Height - sizeNodeRect);                    
                ...
                case PosSizableRect.RightMiddle:
                    return CreateRectSizableNode(rectDraw.X  + rectDraw.Width, rectDraw.Y  + rectDraw.Height / 2, sizeNodeRect, rectDraw.Height - sizeNodeRect);
