...
namespace UserRectDemo
{
    ...
    {        
        ...
        public int SnapSizeX = 1;
        public int SnapSizeY = 1;
        public int SnapSize { set { SnapSizeX = value; SnapSizeY = value; } }
        ...
        {                     
            g.DrawRectangle(pen1,rectDraw);
            g.DrawRectangle(pen2,rectDraw);

            if (DrawResizeHandles)
                foreach (PosSizableRect pos in Enum.GetValues(typeof(PosSizableRect)))
                    g.DrawRectangle(penHandles, GetRect(pos));
        }
        ...
        private void mPictureBox_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (rect.Width < Math.Max(5,SnapSizeX) || rect.Height < Math.Max(5,SnapSizeY))
            {
                rect = backupRect;
            }
            ...
            if (SizeChanged != null) SizeChanged(rectDraw);
        ...
        {
            rectDraw.X = (rect.X / SnapSizeX) * SnapSizeX;
            rectDraw.Y = (rect.Y / SnapSizeY) * SnapSizeY;
            rectDraw.Width = (rect.Width / SnapSizeX) * SnapSizeX;
            rectDraw.Height = (rect.Height / SnapSizeY) * SnapSizeY;
        }
...
/*
        private void TestIfRectInsideArea()
        {
            ...
            if (rect.Width <= 0) rect.Width = SnapSizeX;
            if (rect.Height <= 0) rect.Height = SnapSizeY;
