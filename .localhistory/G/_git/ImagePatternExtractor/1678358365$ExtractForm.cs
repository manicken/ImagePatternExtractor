...
namespace WeaveImagePatternExtractor
{
    public partial class ExtractForm : Form
    {
        ...
        private void btnOpenFile_Click(object sender, EventArgs e)
        {
            ...
            imgSrc = grayscaleFilter.Apply(imgSrc);
        ...
        {
            /*
            AForge.Imaging.Filters.CannyEdgeDetector ced = new CannyEdgeDetector();
            ced.LowThreshold = (byte)trackBar2.Value;
            ced.HighThreshold = (byte)trackBar1.Value;*/
            AForge.Imaging.Filters.Median filter = new AForge.Imaging.Filters.Median(trackBar1.Value);
            //Bitmap bm = new Bitmap(imgSrc, System.Drawing.Imaging.PixelFormat.Format24bppRgb);
            picBox.Image = filter.Apply(imgSrc);
        }
