...
namespace WeaveImagePatternExtractor
{
    public partial class ExtractForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Bitmap grayImage = grayscaleFilter.Apply(imgSrcCopy);
            ExtractPatternCompleted(grayImage);
            ...
            //AForge.Imaging.Filters.Dilatation dilateFilter = new AForge.Imaging.Filters.Dilatation();
            //dilateFilter.ApplyInPlace(thresholdedImage);

            //picBox.Image = thresholdedImage;
        }
