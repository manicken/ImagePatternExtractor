...
namespace WeaveImagePatternExtractor
{
    ...
    public static class BitmapExt
    {
        ...
        public static Bitmap ConvertToBinaryFormat8bppIndexed(this Bitmap bitmap)
        {
            ...
            BitmapData bmdBin = bmBin.LockBits(new Rectangle(0, 0, bitmap.Width, bitmap.Height), ImageLockMode.ReadOnly, bmBin.PixelFormat);
            ...
            Marshal.Copy(bmdBin.Scan0, bmdBinRaw, 0, bmdBinRaw.Length);
