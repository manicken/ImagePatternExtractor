...
namespace WeaveImagePatternExtractor
{
    ...
    public static class BitmapExt
    {
        ...
        public static void SetPixel(Bitmap bitmap, int x, int y, byte color)
        {
        ...
        public static void SetPixel2(Bitmap bitmap, int x, int y, byte color)
        {
            if (bitmap.PixelFormat != PixelFormat.Format8bppIndexed)
            {
                throw new ArgumentException("Bitmap format must be 8bpp grayscale");
            ...
            // Lock the bitmap data
            BitmapData bitmapData = bitmap.LockBits(new Rectangle(x, x, 1, 1),
                ImageLockMode.ReadWrite, bitmap.PixelFormat);
