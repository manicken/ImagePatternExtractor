...
namespace WeaveImagePatternExtractor
{
    ...
    public static class BitmapExt
    {
        ...
        {
            Bitmap bmBinary = new Bitmap(bitmap.Width, bitmap.Height, PixelFormat.Format8bppIndexed);
            BitmapData bmdBinary = bmBinary.LockBits(new Rectangle(0, 0, bitmap.Width, bitmap.Height), ImageLockMode.ReadOnly, bmBinary.PixelFormat);
